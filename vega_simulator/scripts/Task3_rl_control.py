...
class vega_env(gym.Env):
    ...
    def __init__(self, n_sections):
        ...
        self.measured_state = np.zeros(shape=(14,))
    ...
    def complete_pose_callback(self,msg):
        ...
        self.measured_state = np.concatenate((pose,self.target))
...
if __name__ == '__main__':
    ...
    # model = SAC.load("/home/aneesh/catkin_ws/src/Soft_robo_sim/vega_simulator/config/logs/Mar5_Path_Following_6point_states_45000_steps", tensorboard_log="/home/aneesh/catkin_ws/src/Soft_robo_sim/vega_simulator/results")
    # model.set_env(env)

    # # Save a checkpoint every 5000 steps
    # log_dir = os.getcwd()
    # # print(log_dir)
    # checkpoint_callback = CheckpointCallback(save_freq=5000, save_path=log_dir +'/logs/',name_prefix='Mar5_Path_Following_6point_states')
    ...
    # model.learn(total_timesteps=int(2e5), tb_log_name = "Mar5_Path_Following_6point_states", callback=callback)

    # # # save the model
    # model.save(log_dir + "/Mar5_Path_Following_6point_states")

    # # load the trained model
    model = SAC.load("/home/aneesh/catkin_ws/src/Soft_robo_sim/vega_simulator/config/Mar5_Path_Following_6point_states")    
    # # Save the policy independently from the model
    # # Note: if you don't save the complete model with `model.save()`
    # # # you cannot continue training afterward
    # policy = model.policy
    # policy.save("Mar5_Path_Following_6point_states_Policy")
