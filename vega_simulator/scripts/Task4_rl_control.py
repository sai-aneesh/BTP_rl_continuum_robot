...
class vega_env(gym.Env):
    ...
    def step(self, action):
        ...
        reward = - 40*distance  -(vel_diff)*10
...
if __name__ == '__main__':
    ...
    # model = SAC.load("/home/aneesh/catkin_ws/src/Soft_robo_sim/vega_simulator/config/Mar6_Task4_Trajectory_Tracking_560000_steps", tensorboard_log="/home/aneesh/catkin_ws/src/Soft_robo_sim/vega_simulator/results")
    # model.set_env(env)

    # Save a checkpoint every 5000 steps
    log_dir = os.getcwd()
    # print(log_dir)
    checkpoint_callback = CheckpointCallback(save_freq=5000, save_path=log_dir +'/logs/',name_prefix='mar15_Task4_Trajectory_Tracking')
    ...
    model.learn(total_timesteps=int(1e7), tb_log_name = "mar15_Task4_Trajectory_Tracking", callback=callback)

    # # save the model
    model.save(log_dir + "/mar15_Task4_Trajectory_Tracking")

    # load the trained model
    model = SAC.load("/home/aneesh/catkin_ws/src/Soft_robo_sim/vega_simulator/config/mar15_Task4_Trajectory_Tracking")    
    # Save the policy independently from the model
    # Note: if you don't save the complete model with `model.save()`
    # # you cannot continue training afterward
    policy = model.policy
    policy.save("mar15_Task4_Trajectory_Tracking_Policy")
